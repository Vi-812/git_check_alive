...
# xz = analyzer.GitGraphql('vi-812', 'empty')
...
print(f'Описание: {xz.repo_description}')
print(f'Создан: {xz.repo_created_at}')
print(f'Обновлен: {xz.repo_updated_at}')
print(f'Количество звезд: {xz.repo_stars}')
...
print(f'Стоимость запроса: {xz.request_total_cost}, время: {xz.request_duration_time}, баланс: {xz.request_balance}')
print('--------------------------------------------------------------')
